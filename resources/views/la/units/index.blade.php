...
@section("contentheader_description", "Units listing")
@section("section", "Units")
@section("sub_section", "Listing")
@section("htmlheader_title", "Units Listing")

@section("headerElems")
@la_access("Units", "create")
	<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">Add Unit</button>
@endla_access
@endsection
...
<div class="modal fade" id="AddModal" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			{!! Form::open(['action' => 'LA\UnitsController@store', 'id' => 'unit-add-form']) !!}
