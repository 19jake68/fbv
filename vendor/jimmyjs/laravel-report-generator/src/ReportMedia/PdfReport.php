...
class PdfReport extends ReportGenerator
{
	public function make()
	{
		...
		if ($this->withoutManipulation) {
			$html = \View::make('laravel-report-generator::without-manipulation-pdf-template', compact('headers', 'footer', 'columns', 'showTotalColumns', 'query', 'limit', 'groupByArr', 'orientation', 'showHeader', 'showMeta', 'showFooter', 'applyFlush', 'showNumColumn'))->render();
		} else {
			$html = \View::make('laravel-report-generator::general-pdf-template', compact('headers', 'footer', 'columns', 'editColumns', 'showTotalColumns', 'styles', 'query', 'limit', 'groupByArr', 'orientation', 'showHeader', 'showMeta', 'showFooter', 'applyFlush', 'showNumColumn'))->render();
		}
