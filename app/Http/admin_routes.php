...
Route::group(['as' => $as, 'middleware' => ['auth', 'permission:ADMIN_PANEL']], function () {
    ...
    Route::get(config('laraadmin.adminRoute') . '/order_get_item_details_by_activity/{id}/{areaId}/{orderId}', 'LA\OrdersController@getItemDetailsByActivityId');
...
/* ================== Reports ================== */
    ...
    /* ================== Activity_Types ================== */
    Route::resource(config('laraadmin.adminRoute') . '/activity_types', 'LA\Activity_TypesController');
    Route::get(config('laraadmin.adminRoute') . '/activity_type_dt_ajax', 'LA\Activity_TypesController@dtajax');
