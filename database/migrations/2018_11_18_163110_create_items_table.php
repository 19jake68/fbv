...
class CreateItemsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Items", 'items', 'order_id', 'fa-cube', [
            ...
            ["quantity", "Quantity", "Integer", false, "0", 0, 11, false],
            ["measurement", "Measurement", "String", false, "", 0, 256, true],
            ["unit_id", "Unit", "Dropdown", false, "", 0, 0, true, "@units"],
            ["subtotal", "Subtotal", "Decimal", false, "0", 0, 11, false],
        ]);
