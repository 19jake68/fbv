...
class CreateEmployeesTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Employees", 'employees', 'email', 'fa-group', [
            ["name", "Name", "Name", false, "", 5, 250, true],
            ["email", "Email", "Email", true, "", 5, 250, true],
            ["designation", "Designation", "String", false, "", 0, 50, true],
            ["activity_type", "Activity Type", "Dropdown", false, "1", 0, 0, true, "@activity_types"],
            ["areas", "Areas", "Multiselect", false, "", 0, 0, false, "@areas"],
